...
\begin{minipage}[t][0.45\textheight][t]{0.97\linewidth}
  \begin{minipage}[t]{0.49\textwidth}
    ...
    \checkbox{0}\hspace{10pt}Effect of 200ns window on resolution\\~\\
    \checkbox{0}\hspace{10pt}Effect of 200ns window on calibration\\~\\
    \checkbox{0}\hspace{10pt}Runs with Na22 for PET mode\\~\\
    \checkbox{0}\hspace{10pt}Analysis of data in PET mode\\~\\
    \checkbox{1}\hspace{10pt}Upload analysis notebooks\\~\\
  \end{minipage}
  \begin{minipage}[t]{0.49\textwidth}
