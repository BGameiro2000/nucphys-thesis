...
\begin{minipage}[t][0.45\textheight][t]{0.97\linewidth}
  \begin{minipage}[t]{0.49\textwidth}
    ...
    \checkbox{0}\hspace{10pt}Write own versions of scripts\\~\\
  ...
  \begin{minipage}[t]{0.49\textwidth}
    \begin{minipage}[t][0.22\textheight][t]{\textwidth}
        ...
        Started with analysis of the energy resolution of each iTED using Cs137. Used it as a way to compare the analysis using ROOT, PyROOT, and PyData approaches.\\

        Rewrote the scripts provided in order to get familiar with them.\\
    \end{minipage}
    \begin{minipage}[t][0.22\textheight][t]{\textwidth}
        \sectiontitle{Thesis}
    \end{minipage}
